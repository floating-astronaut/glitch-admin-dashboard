...
const COMMANDS: Command[] = [
  ...
  { group: 'Grow', label: 'Grow · Command Center', to: '/grow' },
  { group: 'Grow', label: 'Sales Agent', to: '/grow/sales' },
  { group: 'Grow', label: 'Sales · Glitch Budz', to: '/grow/sales/budz' },
  { group: 'Grow', label: 'Sales · Budz · Leads', to: '/grow/sales/budz/leads' },
  { group: 'Grow', label: 'Sales · Budz · Drafts', to: '/grow/sales/budz/drafts' },
  { group: 'Grow', label: 'Sales · Budz · Sends', to: '/grow/sales/budz/sends' },
  { group: 'Grow', label: 'Ads Agent', to: '/grow/ads' },
  { group: 'Grow', label: 'Social Agent', to: '/grow/social' },
  { group: 'Grow', label: 'UGC Agent', to: '/grow/ugc' },
  { group: 'Grow', label: 'SEO Agent', to: '/grow/seo' },
  { group: 'Grow', label: 'Voice / COD Agent', to: '/grow/voice' },
  { group: 'Edge', label: 'Edge · Betting', to: '/edge' },
  { group: 'Admin', label: 'Home', to: '/' },
  { group: 'Admin', label: 'Customers', to: '/admin/customers' },
  { group: 'Admin', label: 'Customers · Leads', to: '/admin/customers/leads' },
  ...
  { group: 'Admin', label: 'Audit Logs', to: '/admin/audit-logs' },
