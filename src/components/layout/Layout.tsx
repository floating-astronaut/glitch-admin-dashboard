...
const PAGE_TITLES: Record<string, string> = {
  ...
  '/trade/revenue':      'Trade · Revenue',
  '/trade/users':        'Trade · Users',
  '/trade/subscriptions':'Trade · Subscriptions',
  '/trade/billing':      'Trade · Billing',
  '/grow':                          'Grow · Business',
  '/grow/customers':                'Grow · Customers',
  '/grow/customers/leads':          'Grow · Customers · Leads',
  '/grow/users':                    'Grow · Users',
  '/grow/billing':                  'Grow · Billing',
  '/edge':            'Edge · Platform',
